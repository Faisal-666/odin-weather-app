...
const getWeatherData = async (name) => {
    try {
        // const response = await fetch(`https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${name}/next7days/next6days?unitGroup=metric&elements=conditions%2Cdatetime%2CdatetimeEpoch%2Cdescription%2Cfeelslike%2Chumidity%2Cicon%2Cname%2Coffset%2Csource%2Cstations%2Ctemp%2Cwindspeed&include=days&key=${key}&contentType=json`);
